...
class ProyectoTests extends GrailsUnitTestCase {
    ...
    void testUpdate () {
        ...
        def pro2 = Proyecto.findByObjetivoGobiernoResultado(ogr)
        pro2.objetivoGobiernoResultado.descripcion = 'nuevoOgr'
        pro2.save(flush: true)
        assertEquals(1, pro2.count())
        assertEquals('nuevoOgr', pro2.objetivoGobiernoResultado.descripcion)
