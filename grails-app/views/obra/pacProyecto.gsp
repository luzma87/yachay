...
<div style="margin-left: 10px;">
    ...
    <b>Año:</b><g:select from="${yachay.parametros.poaPac.Anio.list([sort:'anio'])}" id="anio_asg"
...
<g:each in="${asgs}" var="asg" status="i">
    <g:set var="obras" value="${yachay.proyectos.Obra.findAllByAsignacionAndObraIsNull(asg, [sort:'id'])}"/>
