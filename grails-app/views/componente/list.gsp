        ...
        <div class="dialog" >
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                                  title="${message(code: 'componente.descripcion.label', default: 'Descripcion')}" />
                        ...
                        <tbody>
                            <g:each in="${componenteInstanceList}" status="i" var="componenteInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                    ...
                                    <td><g:link action="show"d="${componenteInstance.id}">${fieldValue(bean: componenteInstance, field: "descripcion")}</g:link></td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${componenteInstanceTotal}" />
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
