        ...
        <div class="dialog">
            <table>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: sistemaInstance, field: 'nombre', 'errors')}">
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="descripcion"><g:message code="sistema.descripcion.label"
                    ...
                    <td valign="top" class="value ${hasErrors(bean: sistemaInstance, field: 'descripcion', 'errors')}">
                        <g:textArea class="4 field ui-widget-content ui-corner-all" minLenght="1" maxLenght="500"
                                    name="descripcion" id="descripcion" title="Descripcion" cols="40" rows="5"
