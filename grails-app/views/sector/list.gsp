        ...
        <div class="dialog">
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                                    title="${message(code: 'sector.descripcion.label', default: 'Descripción')}"/>
                            ...
                            <g:each in="${sectorInstanceList}" status="i" var="sectorInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                    ...
                                    <td><g:link action="show"
                                                id="${sectorInstance.id}">${fieldValue(bean: sectorInstance, field: "descripcion")}</g:link></td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${sectorInstanceTotal}"/>
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
