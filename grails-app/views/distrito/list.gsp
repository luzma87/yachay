        ...
        <div class="dialog">
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="codigo" class="ui-state-default"
                                                  title="${message(code: 'distrito.codigo.label', default: 'Código')}" />
                                
                                <tdn:sortableColumn property="nombre" class="ui-state-default"
                                                  title="${message(code: 'distrito.nombre.label', default: 'Nombre')}" />
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${distritoInstanceTotal}" />
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
