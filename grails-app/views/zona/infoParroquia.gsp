...
<table width="100%">
    <tbody>
        ...
        <tr>
            <td class="label">
                <g:message code="parroquia.latitud.label"
                           default="Latitud"/>
            </td>
            <td class="campo" id="tdLat">
                ${parroquiaInstance.latitud}
            </td> <!-- campo -->

            <td class="label">
                <g:message code="parroquia.longitud.label"
                           default="Longitud"/>
            </td>
            <td class="campo" id="tdLng">
                ${parroquiaInstance.longitud}
            </td> <!-- campo -->
        </tr>
        ...
        <tr>
            ...
            <td class="label">
                <g:message code="parroquia.zoom.label"
                           default="Zoom"/>
            </td>
            <td class="campo" id="tdZoom">
                ${parroquiaInstance.zoom}
            </td> <!-- campo -->
            <td colspan="2" id="tdModif" class="ui-helper-hidden">
                <g:checkBox name="modif"/>
                Modificar coordenadas
                <a href="#" id="btnSave" style="margin-left: 25px;" class="ui-helper-hidden" data-lat="${parroquiaInstance.latitud}" data-lng="${parroquiaInstance.longitud} data-zoom="${parroquiaInstance.zoom}">Guardar</a>
            </td>
        </tr>
    </tbody>
</table>
...
<script type="text/javascript">
    ...
    var lat = ${parroquiaInstance.latitud};
    var lng = ${parroquiaInstance.longitud};
    var zoom = ${parroquiaInstance.zoom};

    if (lat == 0 && lng == 0) {
        lat = ${parroquiaInstance.canton.latitud};
        lng = ${parroquiaInstance.canton.longitud};
        zoom = ${parroquiaInstance.canton.zoom};
    }
    if (lat == 0 && lng == 0) {
        lat = ${parroquiaInstance.canton.provincia.latitud};
        lng = ${parroquiaInstance.canton.provincia.longitud};
        zoom = ${parroquiaInstance.canton.provincia.zoom};
    }
    ...
    function initialize() {
        ...
        google.maps.event.addListenerOnce(map, "tilesloaded", function () {
            ...
            var image = new google.maps.MarkerImage('${resource(dir:"images/pins/flags", file:"flag_green.png")}',
            ...
            marker = new google.maps.Marker({
                ...
                icon      : image,
                id        : ${parroquiaInstance.id},
                title     : '${parroquiaInstance.nombre}'
            });
...
//                console.log("desactivo");
        ...
        $("#btnSave").button({
            ...
            text  : false
                    ...
                    $.ajax({
                        type    : "POST",
                        url     : "${createLink(action:'updateParroquiaCoords')}",
                        data    : {
                            id   : ${parroquiaInstance.id},
                            lat  : lat,
                            lng  : lng,
