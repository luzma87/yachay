...
<div class="dialog">
    ...
    <g:form action="save" class="frmZona"
            method="post">
                ...
                <tr>
                    <td colspan="6" class="ui-widget ui-widget-header ui-corner-all" style="padding: 3px;">
                        <g:if test="${source == 'edit'}">
                            Editar detalles de la Zona de planificaci&oacute;n
                        </g:if>
                        <g:else>
                            Ingresar detalles de la Zona de planificaci&oacute;n
                        </g:else>
                    </td>
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="prop ${hasErrors(bean: zonaInstance, field: 'numero', 'error')}">
                    ...
                    <td class="" valign="middle">
                        <g:textField class="field number ui-widget-content ui-corner-all" name="numero" title="${Zona.constraints.numero.attributes.mensaje}"
                                     id="numero" value="${fieldValue(bean: zonaInstance, field: 'numero')}"/>
                        %{----}%
                    </td>
                ...
                <tr>
                    <td colspan="6" class="buttons" style="text-align: right;">
                        <g:if test="${source == 'edit'}">
                            ...
                            <g:link class="button show" action="show" id="${zonaInstance?.id}">
