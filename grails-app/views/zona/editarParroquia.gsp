    ...
    <table width="100%" class="ui-widget-content ui-corner-all">
        ...
        <tbody>
                ...
                <td class="campo" valign="middle">
                    ...
                    <g:else>
                        <g:select class="field ui-widget-content ui-corner-all" name="canton.id" title="${Parroquia.constraints.canton.attributes.mensaje}"
                                  from="${yachay.parametros.geografia.Canton.list([sort:'nombre'])}" optionKey="id" value="${parroquiaInstance?.canton?.id}"
                                  noSelection="['null': '']"/>
                    </g:else>
                </td>
            ...
            <tr class="prop ${hasErrors(bean: parroquiaInstance, field: 'nombre', 'error')}">
                ...
                <td class="label " valign="middle">
                    <g:message code="parroquia.numero.label" default="Código"/>
                </td>
                <td class="indicator">
                    &nbsp;
                </td>
                <td class="campo" valign="middle">
                    <g:textField name="codigo" id="codigo" title="${Parroquia.constraints.codigo.attributes.mensaje}"
                                 class="field number ui-widget-content ui-corner-all"
