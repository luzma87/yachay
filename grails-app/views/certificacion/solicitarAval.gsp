...
<head>
    ...
    <title>Solicitud de certificación -- Asignación: ${asg}</title>
...
<div class="breadCrumbHolder module">
    <div id="breadCrumb" class="breadCrumb module">
        <ul>
            <li>
                <g:link class="bc" controller="certificacion" action="solicitarCertificacion">
                    Asignaciones
                </g:link>
            </li>
            <li>
...
<g:uploadForm action="guardarSolicitud">
    <input type="hidden" name="asgn" value="${asg.id}">
    <input type="hidden" name="disp" id="disponible" value="${disponible}">
    <div style="width: 100%;margin-top: 10px;">
        <div class="label">Monto:</div>
        <input type="text" name="monto" id="monto" style="width: 140px;margin-right: 30px;text-align: right" class="ui-corner-all ui-widget-content" value="${disponible}">
    ...
    <div style="margin-left: 20px;margin-top: 20px;">
        ...
        <a href="${g.createLink(action: 'solicitarCertificacion')}" id="cancelar" class="btn_arbol" style="margin-top: 10px">Cancelar</a>
    </div>
</g:uploadForm>
<script>
    $(".btn_arbol").button()
