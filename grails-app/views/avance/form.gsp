...
<div class="dialog">
    ...
    %{--<g:message code="default.list.label" args="${['Avance']}" default="Avance List" />--}%
    %{--</g:link>--}%
    %{--</div>--}%
    ...
    <div id="" class="toolbar ui-widget-header ui-corner-all">
        ...
        <g:link class="button create" action="create">
            <g:message code="avance.new" default="Nuev@ Avance"/>
        </g:link>
    </div> <!-- toolbar -->
    ...
    <g:form action="save" class="frmAvance"
            method="post">
        ...
        <table style="width: 800px;" class="show ui-widget-content ui-corner-all">
            ...
            <tr>
                <td colspan="6" class="ui-widget ui-widget-header ui-corner-all" style="padding: 3px;">
                    <g:if test="${source == 'edit'}">
                        <g:message code="default.edit.legend" args="${['Avance']}" default="Edit Avance details"/>
                    </g:if>
                    <g:else>
                        <g:message code="default.create.legend" args="${['Avance']}" default="Enter Avance details"/>
                    </g:else>
                </td>
            </tr>
            </thead>
            ...
            <tr class="prop ${hasErrors(bean: avanceInstance, field: 'informe', 'error')}">
                ...
                <td class="label " valign="middle">
                    <g:message code="avance.informe.label" default="Informe"/>:
                    %{----}%
                </td>
                <td class="indicator">
                    &nbsp;
                ...
                <td class="label " valign="middle">
                    <g:message code="avance.meta.label" default="Meta"/>:
                    %{----}%
                </td>
                <td class="indicator">
                    &nbsp;
            ...
            <tr class="prop ${hasErrors(bean: avanceInstance, field: 'tasa', 'error')}">
                ...
                <td class="label " valign="middle">
                    <g:message code="avance.tasa.label" default="Tasa"/>:
                    %{----}%
                </td>
                <td class="indicator">
                    &nbsp;
                ...
                <td class="" valign="middle">
                    <g:textArea class="field ui-widget-content ui-corner-all" minLenght="1" maxLenght="1023" name="tasa"
                                id="tasa" title="${Avance.constraints.tasa.attributes.mensaje}" cols="40" rows="5" value="${avanceInstance?.tasa}"/>
                    %{----}%
                </td>
                ...
                <td class=" mandatory" valign="middle">
                    <g:textField class="field number required ui-widget-content ui-corner-all" name="valor"
                                 title="${Avance.constraints.valor.attributes.mensaje}" id="valor" value="${fieldValue(bean: avanceInstance, field: 'valor')}"/>
                    %{--<span class="indicator">*</span>--}%
                </td>
            ...
            <tr>
                <td colspan="6" class="buttons" style="text-align: right;">
                    <g:if test="${source == 'edit'}">
                        ...
                        <g:link class="button show" action="show" id="${avanceInstance?.id}">
