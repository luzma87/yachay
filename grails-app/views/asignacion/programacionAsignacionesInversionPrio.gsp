                    ...
                    <g:each in="${meses}" var="mes" status="j">
                        <g:if test="${ProgramacionAsignacion.findAll('from ProgramacionAsignacion where asignacion = '+asg.id+' and mes = '+mes+' and padre is null').size()>0}" >
                            ...
                            <td class="${mes}" style="width: 70px;">
                                <input type="text" class="${mes} valor asg_cor_${asg.id}" mes="${mes}"   value="${g.formatNumber(number:progra?.valor, format:'###,##0', minFractionDigits:'2',maxFractionDigits:'2')}">
                        ...
                        <g:else>
                            <td class="${mes}" style="width: 70px;">
                                <input type="text" class="${mes} valor asg_cor_${asg.id}" mes="${mes}"   value="0,00">
                            </td>
                        </g:else>
                    </g:each>

                    <td class="total" id="total_cor_${asg.id}" style="width: 80px;">
                        <g:formatNumber number="${asg.priorizado}" format="###,##0" minFractionDigits="2" maxFractionDigits="2"/>
                    </td>

                    <td class=""><a href="#" class="btn guardar ajax" asg="${asg.id}"   icono="ico_cor_${i}" max="${asg.priorizado}" clase="asg_cor_${asg.id}" total="total_cor_${asg.id}">Guardar</a></td>
