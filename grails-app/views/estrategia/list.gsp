        ...
        <div class="dialog" title="${title}">
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="id" class="ui-state-default"
                                                  title="${message(code: 'estrategia.id.label', default: 'Id')}" />
                            ...
                            <g:each in="${estrategiaInstanceList}" status="i" var="estrategiaInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                    ...
                                    <td><g:link action="show"
                                                id="${estrategiaInstance.id}">${fieldValue(bean: estrategiaInstance, field: "id")}</g:link></td>
                                    
                                    <td>${fieldValue(bean: estrategiaInstance, field: "orden")}</td>
                                    
                                    <td>${fieldValue(bean: estrategiaInstance, field: "descripcion")}</td>
                                    
                                    <td>${fieldValue(bean: estrategiaInstance, field: "objetivoEstrategico")}</td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${estrategiaInstanceTotal}" />
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
