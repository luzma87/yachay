...
<%@ page import="yachay.parametros.TipoBien; yachay.parametros.FormaPago; yachay.parametros.TipoContrato; yachay.poa.Actividad; yachay.poa.Componente; yachay.proyectos.Proyecto" contentType="text/html;charset=UTF-8" %>
<html>
    <head>
            ...
            <g:uploadForm action="save" method="post" name="frmSolicitud" id="${solicitud.id}">
                <table width="100%" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <g:select name="tipoBien.id" id="selBien" from="${yachay.parametros.TipoBien.list()}"
