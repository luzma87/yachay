        ...
        onClose: function(dateText, inst) {
            ...
            $('#' + id + '_year').val(year);
                ...
                <div class="buttons">
                    ...
                    <span class="button"><g:actionSubmit class="delete" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Está Seguro?')}');" /></span>
                </div>
            </g:form>
        </div>
    </body>
