...
<html>
    <head>
        ...
        <title>Lista de Etapas de proyecto</title>
        ...
        <div class="dialog">
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                                    title="${message(code: 'etapa.descripcion.label', default: 'Descripción')}"/>
                            ...
                            <g:each in="${etapaInstanceList}" status="i" var="etapaInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                    ...
                                    <td><g:link action="show"
                                                id="${etapaInstance.id}">${fieldValue(bean: etapaInstance, field: "descripcion")}</g:link></td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${etapaInstanceTotal}"/>
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
