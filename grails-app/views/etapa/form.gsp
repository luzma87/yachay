<%@ page import="app.parametros.Etapa" %>
<html>
<head>
    ...
    <div class="dialog">
        ...
        <g:hasErrors bean="${etapaInstance}">
            <div class="errors ui-state-error ui-corner-all">
                <g:renderErrors bean="${etapaInstance}" as="list"/>
            </div>
        </g:hasErrors>
        <g:form action="save" class="frmEtapa"
                method="post">
                    ...
                    <tr>
                        <td colspan="6" class="ui-widget ui-widget-header ui-corner-all" style="padding: 3px;">
                            <g:if test="${source == 'edit'}">
                                Editar detalles de la Etapa de proyecto
                            </g:if>
                            <g:else>
                                Ingresar detalles de la Etapa de proyecto
                            </g:else>
                        </td>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="prop ${hasErrors(bean: etapaInstance, field: 'descripcion', 'error')}">
                        ...
                        <td class="label  mandatory" valign="middle">
                            <g:message code="etapa.descripcion.label" default="Descripción"/>:
                        ...
                        <td class=" mandatory" valign="middle">
                            <g:textField name="descripcion" id="descripcion" title="${Etapa.constraints.descripcion.attributes.mensaje}"
                                         class="field required ui-widget-content ui-corner-all" minLenght="1"
                                         maxLenght="31" value="${etapaInstance?.descripcion}"/>
                            %{--<span class="indicator">*</span>--}%
                        </td>
                    ...
                    <tr>
                        <td colspan="6" class="buttons" style="text-align: right;">
                            <g:if test="${source == 'edit'}">
                                ...
                                <g:link class="button show" action="show" id="${etapaInstance?.id}">
