...
<div class="dialog" title="${title}">
    ...
    <div class="body">
            ...
            <table style="width: 600px;">
                ...
                <tr>
                    ...
                    <tdn:sortableColumn property="id" class="ui-state-default"
                                        title="${message(code: 'politicaAplicaProyecto.id.label', default: 'Id')}"/>

                    <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                        title="${message(code: 'politicaAplicaProyecto.descripcion.label', default: 'Descripcion')}"/>

                </tr>
                </thead>
                <tbody>
                <g:each in="${politicaAplicaProyectoInstanceList}" status="i"
                        var="politicaAplicaProyectoInstance">
                    <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">

                        <td><g:link action="show"
                                    id="${politicaAplicaProyectoInstance.id}">${fieldValue(bean: politicaAplicaProyectoInstance, field: "id")}</g:link></td>

                        <td>${fieldValue(bean: politicaAplicaProyectoInstance, field: "descripcion")}</td>
        ...
        <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
            <tdn:paginate total="${politicaAplicaProyectoInstanceTotal}"/>
        </div>
    </div> <!-- body -->
</div> <!-- dialog -->
