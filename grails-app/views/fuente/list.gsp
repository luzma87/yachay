...
<html>
    <head>
        ...
        <title>Lista de Fuentes de financiamiento</title>
        ...
        <div class="dialog">
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                                    title="${message(code: 'fuente.descripcion.label', default: 'Descripción')}"/>
                            ...
                            <g:each in="${fuenteInstanceList}" status="i" var="fuenteInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                    ...
                                    <td><g:link action="show"
                                                id="${fuenteInstance.id}">${fieldValue(bean: fuenteInstance, field: "descripcion")}</g:link></td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${fuenteInstanceTotal}"/>
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
