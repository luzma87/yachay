...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'accn.label', default: 'Perfiles')}"/>
...
<div style="width: 1020px; margin-bottom:5px; margin-top:10px; padding: 4px;" class="ui-corner-all ui-widget-content">
    <span id="tipo" style="text-align: right; padding-left: 6px;">
        Tipo de acción
        <g:each var="tp" in="${yachay.seguridad.Tpac.list([sort:'id'])}" status="i">
...
<div class="ui-dialog-content ui-widget-content" id="parm" >
    <h3>Seleccione el módulo para fijar permisos o editar acciones y procesos</h3>

        <div style="text-align: left; padding:5px; width: 1000px;" class="ui-corner-all ui-widget-content">
            <div id="botones">
