        ...
        <div class="dialog">
            ...
            <div class="body">
                    ...
                    <table style="width: ${width}px;">
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="tipoProducto" class="ui-state-default"
                                                    title="${message(code: 'tipoProducto.tipoProducto.label', default: 'Tipo de Producto')}"/>
                            ...
                            <g:each in="${tipoProductoInstanceList}" status="i" var="tipoProductoInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                    ...
                                    <td><g:link action="show"
                                                id="${tipoProductoInstance.id}">${fieldValue(bean: tipoProductoInstance, field: "tipoProducto")}</g:link></td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${tipoProductoInstanceTotal}"/>
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
