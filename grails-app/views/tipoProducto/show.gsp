...
<html>
    <head>
        ...
        <g:set var="entityName"
               value="${message(code: 'tipoProducto.label', default: 'TipoProducto')}"/>
                        ...
                        <tbody>
                            ...
                            <tr class="prop ${hasErrors(bean: tipoProductoInstance, field: 'tipoProducto', 'error')}">
                                ...
                                <td class="label" style="width: 10em;">
                                    <g:message code="tipoProducto.tipoProducto.label"
                                               default="Tipo de Producto"/>:
                                </td>

                                <td class="">

                                    ${fieldValue(bean: tipoProductoInstance, field: "tipoProducto")}
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="4" class="buttons" style="text-align: right;">
                                    <g:link class="button edit" action="edit" id="${tipoProductoInstance?.id}">
