        ...
        <div class="dialog">
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                                    title="${message(code: 'calificacion.descripcion.label', default: 'Descripción')}"/>
                            ...
                            <g:each in="${calificacionInstanceList}" status="i" var="calificacionInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                    ...
                                    <td><g:link action="show"
                                                id="${calificacionInstance.id}">${fieldValue(bean: calificacionInstance, field: "descripcion")}</g:link></td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${calificacionInstanceTotal}"/>
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
