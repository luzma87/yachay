...
<html>
    ...
    <body>
        <div class="toolbar ui-widget-header ui-corner-all" style="margin-bottom: 10px;">
            ...
            <a href="#" id="btnDisc">Ver discrepancias</a>
        </div>
        ...
        <script type="text/javascript">
            ...
            function reporte(print) {
                ...
                if (elems != "") {
                    if (print == "web") {
                        var url = "${createLink(action: 'poaReporteWeb')}?anio=" + $("#anio").val() + "&id=" + elems;
                        window.open(url, "_blank");
                    } else if (print == "pdf") {
                        var url = "${createLink(action: 'poaReportePDF')}?id=" + elems;
                        location.href = "${createLink(controller:'pdf',action:'pdfLink')}?anio=" + $("#anio").val() + "Wurl=" + url
                    } else if (print == "csv") {
                        location.href = "${createLink(action:'poaReporteCsv')}?anio=" + $("#anio").val() + "&id=" + elems + "&mes=false";
                    } else if (print == "csv2") {
                        location.href = "${createLink(action:'poaReporteCsv')}?anio=" + $("#anio").val() + "&id=" + elems + "&mes=true";
                    } else if (print == "disc") {
