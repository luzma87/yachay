...
<head>
    ...
    <title>Diagrama del marco l&oacute;gico del proyecto</title>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function reporte(print) {
            ...
            if (elems != "") {
                if (!print) {
                    var url = "${createLink(action: 'fichaMarcoLogicoWeb')}?id=" + elems;
                    window.open(url, "_blank");
                } else {
                    var url = "${createLink(action: 'fichaMarcoLogicoPDF')}?id=" + elems;
