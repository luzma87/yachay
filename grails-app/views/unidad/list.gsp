        ...
        <div class="dialog" title="${title}">
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                <tdn:sortableColumn property="codigo" class="ui-state-default"
                                                    title="${message(code: 'unidad.codigo.label', default: 'Código')}"/>

                                <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                                    title="${message(code: 'unidad.descripcion.label', default: 'Descripción')}"/>
                        ...
                        <tbody>
                            <g:each in="${unidadInstanceList}" status="i" var="unidadInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                    ...
                                    <td><g:link action="show" id="${unidadInstance.id}">
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${unidadInstanceTotal}"/>
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
