    ...
    <g:form action="save" class="frmUnidad"
        ...
        <table width="80%" class="ui-widget-content ui-corner-all">
            ...
            <tbody>
                ...
                <tr class="prop ${hasErrors(bean: unidadInstance, field: 'codigo', 'error')}">
                    ...
                    <td class="campo" valign="middle">
                        <g:textField name="codigo" id="codigo" title="${Unidad.constraints.codigo.attributes.mensaje}"
                                     class="field ui-widget-content ui-corner-all"
                                     minLenght="1" maxLenght="7" value="${unidadInstance?.codigo}"  style="width: 80px"/>
                        %{----}%
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="campo" valign="middle">
                        <g:textField name="descripcion" id="descripcion" title="${Unidad.constraints.descripcion.attributes.mensaje}"
                ...
                <tr>
                    <td colspan="6" class="buttons" style="text-align: right;">
                        <g:if test="${source == 'edit'}">
                            ...
                            <g:link class="button show" action="show" id="${unidadInstance?.id}">
