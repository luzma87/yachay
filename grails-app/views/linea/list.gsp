...
<html>
    <head>
        ...
        <title>Lista de Lineamientos de inversión</title>
        ...
        <div class="dialog">
            ...
            <div id="" class="toolbar ui-widget-header ui-corner-all">
                <g:link class="button create" action="create">
                    Nuevo Lineamiento de inversión
                </g:link>
            </div> <!-- toolbar -->
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                                  title="${message(code: 'linea.descripcion.label', default: 'Descripción')}" />
                            ...
                            <g:each in="${lineaInstanceList}" status="i" var="lineaInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                    ...
                                    <td><g:link action="show"
                                                id="${lineaInstance.id}">${fieldValue(bean: lineaInstance, field: "descripcion")}</g:link></td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${lineaInstanceTotal}" />
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
