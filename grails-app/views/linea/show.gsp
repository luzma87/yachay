...
<html>
    <head>
        ...
        <title>Ver Lineamiento de inversión</title>
    </head>
                        ...
                        <thead>
                            <tr>
                                <td colspan="4" class="ui-widget ui-widget-header ui-corner-all" style="padding: 3px;">
                                    Ver detalles del Lineamiento de inversión
                                </td>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr class="prop ${hasErrors(bean: lineaInstance, field: 'descripcion', 'error')}">
                                ...
                                <td class="label" style="width: 10em;">
                                    <g:message code="linea.descripcion.label"
                                               default="Descripción"/>:
                                </td>

                                <td class="">

                                    ${fieldValue(bean: lineaInstance, field: "descripcion")}
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="4" class="buttons" style="text-align: right;">
                                    <g:link class="button edit" action="edit" id="${lineaInstance?.id}">
