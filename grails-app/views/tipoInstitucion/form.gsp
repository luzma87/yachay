    ...
    <body>
        <div class="dialog" title="${title}">
            ...
            <div class="body">
                ...
                <g:form action="save" class="frmTipoInstitucion"
                        method="post">
                    ...
                    <div>
                        <fieldset class="ui-corner-all">
                            ...
                            <div class="prop mandatory ${hasErrors(bean: tipoInstitucionInstance, field: 'codigo', 'error')}">
                                <label for="codigo">
                                    <g:message code="tipoInstitucion.codigo.label" default="Codigo"/>
                            ...
                            <div class="prop ${hasErrors(bean: tipoInstitucionInstance, field: 'descripcion', 'error')}">
                            ...
                            <div class="buttons">
                                <g:if test="${source == 'edit'}">
                                    ...
                                    <g:link class="button show" action="show" id="${tipoInstitucionInstance?.id}">
