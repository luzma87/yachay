        ...
        <div class="dialog" title="${title}">
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="id" class="ui-state-default"
                                                  title="${message(code: 'auxiliar.id.label', default: 'Id')}" />
                                
                                <tdn:sortableColumn property="presupuesto" class="ui-state-default"
                                                  title="${message(code: 'auxiliar.presupuesto.label', default: 'Presupuesto')}" />
                            ...
                            <g:each in="${auxiliarInstanceList}" status="i" var="auxiliarInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                    ...
                                    <td><g:link action="show"
                                                id="${auxiliarInstance.id}">${fieldValue(bean: auxiliarInstance, field: "id")}</g:link></td>
                                    
                                    <td>${fieldValue(bean: auxiliarInstance, field: "presupuesto")}</td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${auxiliarInstanceTotal}" />
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
