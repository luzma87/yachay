...
<div class="dialog" title="${title}">
    ...
    <div class="body">
            ...
            <table style="width: 600px;">
                ...
                <tr>
                    ...
                    <tdn:sortableColumn property="id" class="ui-state-default"
                                        title="${message(code: 'cargoPersonal.id.label', default: 'Id')}"/>

                    <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                        title="${message(code: 'cargoPersonal.descripcion.label', default: 'Descripcion')}"/>
                ...
                <g:each in="${cargoPersonalInstanceList}" status="i" var="cargoPersonalInstance">
                    <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                        ...
                        <td><g:link action="show"
                                    id="${cargoPersonalInstance.id}">${fieldValue(bean: cargoPersonalInstance, field: "id")}</g:link></td>

                        <td>${fieldValue(bean: cargoPersonalInstance, field: "descripcion")}</td>
        ...
        <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
            <tdn:paginate total="${cargoPersonalInstanceTotal}"/>
        </div>
    </div> <!-- body -->
</div> <!-- dialog -->
