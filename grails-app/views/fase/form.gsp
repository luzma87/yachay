...
<body>
    <div class="dialog">
        ...
        <g:form action="save" class="frmFase"
                method="post">
            ...
            <table style="width: 800px;" class="show ui-widget-content ui-corner-all">
                    ...
                    <tr>
                        <td colspan="6" class="ui-widget ui-widget-header ui-corner-all" style="padding: 3px;">
                            <g:if test="${source == 'edit'}">
                                Editar detalles de la Fase de proyecto
                            </g:if>
                            <g:else>
                                Ingresar detalles de la Fase de proyecto
                            </g:else>
                        </td>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="prop ${hasErrors(bean: faseInstance, field: 'descripcion', 'error')}">

                        <td class="label  mandatory" valign="middle">
                            <g:message code="fase.descripcion.label" default="Descripción"/>:
                        ...
                        <td class=" mandatory" valign="middle">
                            <g:textField name="descripcion" id="descripcion" title="${Fase.constraints.descripcion.attributes.mensaje}"
                                         class="field required ui-widget-content ui-corner-all" minLenght="1"
                                         maxLenght="31" value="${faseInstance?.descripcion}"/>
                            %{--<span class="indicator">*</span>--}%
                        </td>
                    ...
                    <tr>
                        <td colspan="6" class="buttons" style="text-align: right;">
                            <g:if test="${source == 'edit'}">
                                ...
                                <g:link class="button delete" action="delete" id="${faseInstance?.id}">
                                    <g:message code="default.button.delete.label" default="Delete"/>
                                </g:link>
                                <g:link class="button show" action="show" id="${faseInstance?.id}">
