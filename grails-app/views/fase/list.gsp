        ...
        <div class="dialog">
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                                    title="${message(code: 'fase.descripcion.label', default: 'Descripción')}"/>
                            ...
                            <g:each in="${faseInstanceList}" status="i" var="faseInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                    ...
                                    <td><g:link action="show"
                                                id="${faseInstance.id}">${fieldValue(bean: faseInstance, field: "descripcion")}</g:link></td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${faseInstanceTotal}"/>
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
