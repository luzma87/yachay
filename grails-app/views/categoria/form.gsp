    ...
    <body>
            <div class="dialog" title="${title}">
                ...
                <div class="body">
                    ...
                    <g:form action="save" class="frmCategoria"
                            method="post"  >
                        ...
                        <fieldset class="ui-corner-all">
                            <legend class="ui-widget ui-widget-header ui-corner-all">
                                <g:if test="${source == 'edit'}">
                                    <g:message code="categoria.edit.legend" default="Edit Categoria details"/>
                                </g:if>
                                <g:else>
                                    <g:message code="categoria.create.legend" default="Enter Categoria details"/>
                                </g:else>
                </legend>
                    
                    <div class="prop mandatory ${hasErrors(bean: categoriaInstance, field: 'descripcion', 'error')}">
                    ...
                    <div class="prop mandatory ${hasErrors(bean: categoriaInstance, field: 'codigo', 'error')}">
                        <label for="codigo">
                    ...
                    <div class="buttons">
                        <g:if test="${source == 'edit'}">
                            ...
                            <g:link class="button show" action="show" id="${categoriaInstance?.id}">
