...
<html>
    <head>
        ...
        <title>Lista de Tipos de adquisición</title>
        ...
        <div class="dialog">
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                                  title="${message(code: 'tipoAdquisicion.descripcion.label', default: 'Descripción')}" />
                                
                            </tr>
                        </thead>
                        <tbody>
                            <g:each in="${tipoAdquisicionInstanceList}" status="i" var="tipoAdquisicionInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">

                                    
                                    <td><g:link action="show"
                                                id="${tipoAdquisicionInstance.id}">${fieldValue(bean: tipoAdquisicionInstance, field: "descripcion")}</g:link></td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${tipoAdquisicionInstanceTotal}" />
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
