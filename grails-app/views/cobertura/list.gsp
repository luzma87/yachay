...
<html>
    <head>
        ...
        <title>Lista de Coberturas de proyecto</title>
        ...
        <div class="dialog">
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                                  title="${message(code: 'cobertura.descripcion.label', default: 'Descripción')}" />
                            ...
                            <g:each in="${coberturaInstanceList}" status="i" var="coberturaInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                    ...
                                    <td><g:link action="show"
                                                id="${coberturaInstance.id}">${fieldValue(bean: coberturaInstance, field: "descripcion")}</g:link></td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${coberturaInstanceTotal}" />
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
