        ...
        <div class="dialog" title="${title}">
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="id" class="ui-state-default"
                                                    title="${message(code: 'provincia.id.label', default: 'Id')}"/>

                                <th class="ui-state-default"><g:message code="provincia.zona.label"
                                                                        default="Zona"/></th>

                                <th class="ui-state-default"><g:message code="provincia.region.label"
                                                                        default="Region"/></th>

                                <tdn:sortableColumn property="numero" class="ui-state-default"
                                                    title="${message(code: 'provincia.numero.label', default: 'Numero')}"/>

                                <tdn:sortableColumn property="nombre" class="ui-state-default"
                                                    title="${message(code: 'provincia.nombre.label', default: 'Nombre')}"/>
                            ...
                            <g:each in="${provinciaInstanceList}" status="i" var="provinciaInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                    ...
                                    <td><g:link action="show"
                                                id="${provinciaInstance.id}">${fieldValue(bean: provinciaInstance, field: "id")}</g:link></td>

                                    <td>${fieldValue(bean: provinciaInstance, field: "zona")}</td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${provinciaInstanceTotal}"/>
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
