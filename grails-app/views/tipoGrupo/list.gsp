...
<html>
    <head>
        ...
        <title>Lista de Tipos de grupo de atención</title>
        ...
        <div class="dialog">
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                                  title="${message(code: 'tipoGrupo.descripcion.label', default: 'Descripción')}" />
                                
                            </tr>
                        </thead>
                        <tbody>
                            <g:each in="${tipoGrupoInstanceList}" status="i" var="tipoGrupoInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">

                                    
                                    <td><g:link action="show"
                                                id="${tipoGrupoInstance.id}">${fieldValue(bean: tipoGrupoInstance, field: "descripcion")}</g:link></td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${tipoGrupoInstanceTotal}" />
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
