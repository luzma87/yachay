    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            function reporte(print) {
                ...
                if (elems != "") {
                    if (print == "web") {
                        var url = "${createLink(action: 'techosWeb')}?id=" + elems;
                        window.open(url, "_blank");
                    } else if (print == "pdf") {
                        var url = "${createLink(action: 'techosPdf')}?id=" + elems;
                        location.href = "${createLink(controller:'pdf',action:'pdfLink')}?url=" + url
                    } else if (print == "csv") {
                        location.href = "${createLink(action:'techosCsv')}?anio=" + $("#anio").val() + "&id=" + elems;
                    }
                } else {
