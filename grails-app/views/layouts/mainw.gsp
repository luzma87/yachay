...
<html>
    ...
    <body>
        ...
        <div class="ui-dialog ui-widget ui-widget-content ui-corner-all"
             style="height: 740px;  width: 1330px; margin-left:2px; position: absolute; left: 2px; top:2px;overflow-y: hidden; font-family: 'Arial'">
            ...
            <div id="divDlgBody" class="ui-dialog-content ui-widget-content" style="height: 640px;width: 98%">
                <g:layoutBody/>
