...
<html>
    <head>
        ...
        <title>Lista de Tipos de meta</title>
    </head>
        ...
        <div class="dialog" title="${title}">
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                                    title="${message(code: 'tipoMeta.descripcion.label', default: 'Descripción')}"/>

                            </tr>
                        </thead>
                        <tbody>
                            <g:each in="${tipoMetaInstanceList}" status="i" var="tipoMetaInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">

                                    <td><g:link action="show" id="${tipoMetaInstance.id}">
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${tipoMetaInstanceTotal}"/>
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
