            ...
            <div class="dialog" title="${title}">
                ...
                %{--<div id="" class="toolbar ui-widget-header ui-corner-all">--}%
                    ...
                    %{--<g:link class="button list" action="list">--}%
                        %{--<g:message code="default.list.label" args="${['Intervencion']}" default="Intervencion List" />--}%
                    %{--</g:link>--}%
                %{--</div>--}%
                    ...
                    <g:form action="save" class="frmIntervencion"
                            method="post"  >
                                ...
                                <tr>
                                    <td colspan="6" class="ui-widget ui-widget-header ui-corner-all" style="padding: 3px;">
                                        <g:if test="${source == 'edit'}">
                                            <g:message code="default.edit.legend" args="${['Intervencion']}" default="Edit Intervencion details"/>
                                        </g:if>
                                        <g:else>
                                            <g:message code="default.create.legend" args="${['Intervencion']}" default="Enter Intervencion details"/>
                                        </g:else>
                                    </td>
                                </tr>
                            </thead>
                    ...
                    <tr class="prop ${hasErrors(bean: intervencionInstance, field: 'proyecto', 'error')}">
                        ...
                        <td class="label " valign="middle">
                            <g:message code="intervencion.proyecto.label" default="Proyecto" />
                            %{----}%
                        </td>
                        <td class="indicator">
                            &nbsp;
                        ...
                        <g:if test="${source == 'edit'}">
                            ...
                            <g:link class="button show" action="show" id="${intervencionInstance?.id}">
