...
<html>
    <head>
        ...
        <title>Lista de Tipos de participaci&oacute;n</title>
        ...
        <div class="dialog">
            ...
            <div id="" class="toolbar ui-widget-header ui-corner-all">
                <g:link class="button create" action="create">
                    Nuevo Tipo de participaci&oacute;n
                </g:link>
            </div> <!-- toolbar -->
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                                    title="${message(code: 'tipoParticipacion.descripcion.label', default: 'Descripción')}"/>

                            </tr>
                        </thead>
                        <tbody>
                            <g:each in="${tipoParticipacionInstanceList}" status="i" var="tipoParticipacionInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">

                                    <td><g:link action="show"
                                                id="${tipoParticipacionInstance.id}">${fieldValue(bean: tipoParticipacionInstance, field: "descripcion")}</g:link></td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${tipoParticipacionInstanceTotal}"/>
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
