...
<html>
    <head>
        ...
        <title>Lista de Grupos de procesos</title>
    </head>
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="id" class="ui-state-default"
                                                  title="${message(code: 'grupoProcesos.id.label', default: 'Id')}" />
                                
                                <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                                  title="${message(code: 'grupoProcesos.descripcion.label', default: 'Descripción')}" />
                            ...
                            <g:each in="${grupoProcesosInstanceList}" status="i" var="grupoProcesosInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                    ...
                                    <td><g:link action="show"
                                                id="${grupoProcesosInstance.id}">${fieldValue(bean: grupoProcesosInstance, field: "id")}</g:link></td>
                                    
                                    <td>${fieldValue(bean: grupoProcesosInstance, field: "descripcion")}</td>
