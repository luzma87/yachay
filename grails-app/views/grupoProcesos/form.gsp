...
<body>
<g:set var="entityName" value="GrupoProcesos"/>
<div class="dialog">
    ...
    %{--<g:message code="default.list.label" args="${['GrupoProcesos']}" default="GrupoProcesos List" />--}%
    %{--</g:link>--}%
    %{--</div>--}%

    <div id="" class="toolbar ui-widget-header ui-corner-all">
        <g:link class="button list" action="list">
            Lista de Grupos de procesos
        </g:link>
    </div> <!-- toolbar -->
    ...
    <g:hasErrors bean="${grupoProcesosInstance}">
        <div class="errors ui-state-error ui-corner-all">
            <g:renderErrors bean="${grupoProcesosInstance}" as="list"/>
        </div>
    </g:hasErrors>
    <g:form action="save" class="frmGrupoProcesos"
            method="post">
        <g:hiddenField name="id" value="${grupoProcesosInstance?.id}"/>
        <g:hiddenField name="version" value="${grupoProcesosInstance?.version}"/>
        ...
        <table style="width: 800px;" class="show ui-widget-content ui-corner-all">
                ...
                <tr>
                    <td colspan="6" class="ui-widget ui-widget-header ui-corner-all" style="padding: 3px;">
                        <g:if test="${source == 'edit'}">
                            Editar detalles del Grupo de procesos
                        </g:if>
                        <g:else>
                            Ingresar detalles del Grupo de procesos
                        </g:else>
                    </td>
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="prop ${hasErrors(bean: grupoProcesosInstance, field: 'descripcion', 'error')}">

                    <td class="label  mandatory" valign="middle">
                        <g:message code="grupoProcesos.descripcion.label" default="Descripción"/>:
                ...
                <tr>
                    <td colspan="6" class="buttons" style="text-align: right;">
                        <g:if test="${source == 'edit'}">
                            ...
                            <g:link class="button delete" action="delete" id="${grupoProcesosInstance?.id}">
                                <g:message code="default.button.delete.label" default="Delete"/>
                            </g:link>
                            <g:link class="button show" action="show" id="${grupoProcesosInstance?.id}">
