    ...
    <body>
        ...
        <div class="body" style="font-size: 11px">
            <div class="dialog">
                ...
                <g:form action="guardarSolicitud" class="frmModificacionProyecto"
                        method="post">
                    ...
                    <table width="500px" class="ui-widget-content ui-corner-all">
                        ...
                        <tbody>
                            ...
                            <tr class="prop ${hasErrors(bean: moficacion, field: 'tipo', 'error')}">
                                ...
                                <td class="label " valign="middle">
                                    Valor a modificar de la inversi&oacute;n
                                </td>
                                <td class="indicator">
                                    &nbsp;
                                </td>
                                <td class="campo" valign="middle">
                                    <g:textField class="field number required ui-widget-content ui-corner-all"
                                                 name="valor"
                                                 title="${ModificacionProyecto.constraints.valor.attributes.mensaje}"
                                                 id="valor" value="${modificacion?.valor}"/>
                                    %{----}%
                                </td>
