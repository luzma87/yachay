    ...
    <table style="width: 100%">
        ...
        <g:each in="${detalle}" var="asg">
            ...
            <tr>
                ...
                <td style="text-align: right" id="monto_${asg.id}"><g:formatNumber number="${asg.monto}" format="###,##0" minFractionDigits="2" maxFractionDigits="2" ></g:formatNumber></td>
                <td style="text-align: right">
                    <input type="text" class="det_${asg.id} detalle"  iden="${asg.id}" value="${asg.monto}" style="width: 100px;text-align: right" max="${asg.monto}">
                </td>
