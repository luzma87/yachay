...
<html>
    <head>
        ...
        <title>Ver Estado de proyecto</title>
    </head>
                        ...
                        <tbody>
                            ...
                            <tr class="prop ${hasErrors(bean: estadoProyectoInstance, field: 'descripcion', 'error')}">
                                ...
                                <td class="label" style="width: 10em;">
                                    <g:message code="estadoProyecto.descripcion.label"
                                               default="Descripción"/>:
                                </td>

                                <td class="">

                                    ${fieldValue(bean: estadoProyectoInstance, field: "descripcion")}
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="4" class="buttons" style="text-align: right;">
                                    <g:link class="button edit" action="edit" id="${estadoProyectoInstance?.id}">
