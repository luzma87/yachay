                ...
                %{--</div>--}%
                    ...
                    <tr class="prop ${hasErrors(bean: BeneficioSempladesInstance, field: 'proyecto', 'error')}">
                        ...
                        <td class="campo" valign="middle">
                            <g:select class="field ui-widget-content ui-corner-all" name="proyecto.id" title="${BeneficioSemplades.constraints.proyecto.attributes.mensaje}" from="${app.Proyecto.list()}" optionKey="id" value="${BeneficioSempladesInstance?.proyecto?.id}" noSelection="['null': '']" />
                            %{----}%
                        </td>
