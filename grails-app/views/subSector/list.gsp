        ...
        <div class="dialog">
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                                  title="${message(code: 'subSector.descripcion.label', default: 'Descripción')}" />
                                
                            </tr>
                        </thead>
                        <tbody>
                            <g:each in="${subSectorInstanceList}" status="i" var="subSectorInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">

                                    
                                    <td><g:link action="show"
                                                id="${subSectorInstance.id}">${fieldValue(bean: subSectorInstance, field: "descripcion")}</g:link></td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${subSectorInstanceTotal}" />
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
