        ...
        <div class="dialog" title="${title}">
            ...
            <div class="body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tdn:sortableColumn property="id" class="ui-state-default"
                                                  title="${message(code: 'tipoDocumento.id.label', default: 'Id')}" />
                                
                                <tdn:sortableColumn property="descripcion" class="ui-state-default"
                                                  title="${message(code: 'tipoDocumento.descripcion.label', default: 'Descripcion')}" />
                            ...
                            <g:each in="${tipoDocumentoInstanceList}" status="i" var="tipoDocumentoInstance">
                                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                    ...
                                    <td><g:link action="show"
                                                id="${tipoDocumentoInstance.id}">${fieldValue(bean: tipoDocumentoInstance, field: "id")}</g:link></td>
                ...
                <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bottom ui-helper-clearfix paginateButtons">
                    <tdn:paginate total="${tipoDocumentoInstanceTotal}" />
                </div>
            </div> <!-- body -->
        </div> <!-- dialog -->
